...
// import {
//     Badge
// } from "@/components/task-list/tasklist"
...
//   );
// }
// app/(main)/history-page/page.tsx
import { prisma } from "@/lib/prisma";
import HistoryClient from "@/components/history/HistoryClient";
import type { Task } from "@/types/type";
import { Status } from "@prisma/client";

const USER_ID = 1; // TODO: 認証で差し替え
...
export default async function Page() {
  ...
  // UI用 Task に整形（category は string へ）
  const tasks: Task[] = tasksDb.map((t) => ({
    id: t.id,                      // number のまま
    title: t.title,
    status: t.status,              // enum のまま
    priority: t.priority,          // enum のまま
